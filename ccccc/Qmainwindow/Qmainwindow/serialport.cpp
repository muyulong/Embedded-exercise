...
void new_main::on_openMyComBtn_clicked()
...
void new_main::on_closeMyComBtn_clicked()
{
    myCom->close();
...
void new_main::on_sendMsgBtn_clicked()
{
    myCom->write(ui->sendMsgLineEdit->text().toAscii());
}

void new_main::on_saveMyComBtn_clicked()
{
