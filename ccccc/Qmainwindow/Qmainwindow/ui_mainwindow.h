...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/new/pic/images/\346\224\266\345\217\221\345\255\227\347\254\246.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        action_C->setIcon(icon3);
        action_F = new QAction(MainWindow);
        action_F->setObjectName(QString::fromUtf8("action_F"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/new/pic/images/\346\224\266\345\217\221\346\226\207\344\273\266.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        action_F->setIcon(icon4);
        action_V = new QAction(MainWindow);
        action_V->setObjectName(QString::fromUtf8("action_V"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/new/pic/images/\346\237\245\347\234\213\346\226\207\344\273\266.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        action_V->setIcon(icon5);
        action_H = new QAction(MainWindow);
        action_H->setObjectName(QString::fromUtf8("action_H"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/new/pic/images/\345\270\256\345\212\251.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        action_H->setIcon(icon6);
        action_F_2 = new QAction(MainWindow);
        action_F_2->setObjectName(QString::fromUtf8("action_F_2"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/new/pic/images/\346\204\217\350\247\201\345\217\215\351\246\210.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        action_F_2->setIcon(icon7);
        action_A = new QAction(MainWindow);
        action_A->setObjectName(QString::fromUtf8("action_A"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/new/pic/images/\345\205\263\344\272\216\347\263\273\347\273\237.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        action_A->setIcon(icon8);
        action_S = new QAction(MainWindow);
        action_S->setObjectName(QString::fromUtf8("action_S"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/new/pic/images/\351\200\232\344\277\241\350\256\276\347\275\256.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        action_S->setIcon(icon9);
        ...
        label->setGeometry(QRect(10, 0, 871, 461));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action_E->setText(QApplication::translate("MainWindow", "\344\270\262\345\217\243\351\200\232\350\256\257\350\256\276\347\275\256(E)", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("MainWindow", "<html><head/><body><p><img src=\":/new/photo_2.jpg\"/></p></body></html>", 0, QApplication::UnicodeUTF8));
